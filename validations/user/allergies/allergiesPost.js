...
const allergiesPostValidation = (data) => {
  const Schema = Joi.object({
    ...
    allergen: Joi.string()
      ...
      .messages({
        ...
        "string.pattern.base":
          "Allergen can only contain a combination of alphabets, numbers and special characters",
...
module.exports = allergiesPostValidation;
