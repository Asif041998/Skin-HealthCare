...
const speakerSeriesValidationsPut = (data) => {
  const Schema = Joi.object({
    ...
    event_date: Joi.date().iso().messages({
    ...
    speaker_id: Joi.number().integer().messages({
...
module.exports = speakerSeriesValidationsPut;
